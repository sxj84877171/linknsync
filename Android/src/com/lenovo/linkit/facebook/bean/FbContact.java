...
public class FbContact implements Parcelable {
	...
	public static Comparator<FbContact> NAME_COMPARATOR = new Comparator<FbContact>() {
	...
	public static final Parcelable.Creator<FbContact> CREATOR = new Parcelable.Creator<FbContact>() {
