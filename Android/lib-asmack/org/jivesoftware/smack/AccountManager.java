...
public class AccountManager {
     ...
     */
    public IQ createAccount(String username, String password) throws XMPPException {
     ...
     */
    public IQ createAccount(String username, String password, Map<String, String> attributes)
            throws XMPPException
    {
        ...
        System.out.println("response:"+result.toXML());
