...
public class Roster {
	...
	// 鍒濆鍖�	private boolean initialized = false;
	...
	private void insertRosterItem(RosterPacket.Item item, Collection<String> addedEntries, Collection<String> updatedEntries,
			Collection<String> deletedEntries) {
		RosterEntry entry = new RosterEntry(item.getUser(), item.getName(), item.getItemType(), item.getItemStatus(), this,
				connection);
	...
	private void fireRosterChangedEvent(Collection<String> addedEntries, Collection<String> updatedEntries,
		...
		for (RosterListener listener : rosterListeners) {
			...
			//if (!initialized) {
			//	listener.entriesLoaded(entries.values());
			//}
		}
	...
	// public interface RosterLoadedListner {
	// public void onRosterLoaded();
	// }
	// RosterLoadedListner rosterLoadedListner;

	// public void setRosterLoadedListner(RosterLoadedListner
	// rosterLoadedListner) {
	// this.rosterLoadedListner = rosterLoadedListner;
	// }
