...
public class MUCOwner extends IQ {
	...
	public static class Item {
		...
		public boolean isSubchief() {
			return isSubchief;
		}

		public void setSubchief(boolean isSubchief) {
			this.isSubchief = isSubchief;
		}
		...
		public String toXML() {
			...
			if (isSubchief) {
				buf.append(" subchief=\"").append("1").append("\"");
			}
