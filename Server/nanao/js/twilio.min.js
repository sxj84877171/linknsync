...
b=0;b<d.length;b++)if(a.href=d[b].src,/(twilio\.js)|(twilio\.min\.js)$/.test(a.pathname))return{host:a.host,minified:/\.min\.js$/.test(a.pathname)}}(),h=b.minified?"/twilio.min.js":"/twilio.js",l=document.getElementsByTagName("script")[0],e=document.createElement("script");e.type="text/javascript";e.src="//"+b.host+"/libs/twiliojs/refs/82278dd"+h;e.onload=e.onreadystatechange=function(){e.readyState&&"loaded"!=e.readyState||(f.run(Twilio.Device),k.run(Twilio.EventStream))};l.parentNode.insertBefore(e,
